    ...
    if(isset($_POST["btn_submit_register"]) && !empty($_POST["btn_submit_register"])){
        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(($_SESSION["rand"] != $captcha) && ($_SESSION["rand"] != "")){
                ...
                $error_message = "<p class='mesage_error'><strong>Ошибка!</strong> Вы ввели неправильную цифры с капчи </p>";
            ...
            $result_query_insert = $mysqli->query("INSERT INTO `users` (first_name, last_name, email, password) VALUES 
            ...
            if(!$result_query_insert){
                ...
                $_SESSION["success_messages"] = "<p class='success_message'>Регистрация прошла успешно!!! 
                <br />Теперь Вы можете авторизоваться используя Ваш логин и пароль.</p>";
            ...
            exit("<p><strong>Ошибка!</strong> Отсутствует проверечный код, то есть код капчи. 
