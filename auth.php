<?php
    ...
    $_SESSION["error_messges"]='';

    //Объявляем ячейку для добавления положительного отклика
    $_SESSION["success_messages"]='';

    /**
     * Проверяем была ли отправлена форма, т.е. была ли нажата кнопка Войти
     * Если да, то идем дальше, если нет, то выведем сообщение об ошибке,
     * о том что он зашел на эту страницу напрямую
     */
...
if(isset($_POST["captcha"])){
    ...
    //Убераем пробелы с начала и с конца строки
...
if(!$result_query_select){
    ...
    exit("<p><strong>Ошибка!</strong> Отсутствует проверочный код, то есть код капчи.
