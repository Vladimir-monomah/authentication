...
<div class="block_for_messages">
    <?php
        if(isset($_SESSION["error_messages"])&& !empty($_SESSION["error_messages"])){
            ...
            //Уничтожаем сессию, чтобы не появилось заново при обновлении страницы
            unset($_SESSION["error_messages"]);
        }

        if(isset($_SESSION["success_mesages"])&& !empty($_SESSION["success_mesages"])){
            echo $_SESSION["success_mesages"];

            //Уничтожаем сессию, чтобы не появилось заново при обновлении страницы
            unset($_SESSION["success_mesages"]);
        }
    ?>
</div>
